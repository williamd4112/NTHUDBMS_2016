...
public class SqlParser {
	...
	public static void main(String args[]) throws IOException{
		 ...
		 SqlParser sqlparser=new SqlParser(AlartTxt.toString());
	}
	public SqlParser(String queries){
